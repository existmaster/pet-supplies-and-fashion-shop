<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            <String label="상품 아이디" v-model="value.productId" :editMode="editMode" :inputUI="''"/>
            <Number label="수량" v-model="value.quantity" :editMode="editMode" :inputUI="''"/>
            <Address offline label="배송 주소" v-model="value.shippingAddress" :editMode="editMode" @change="change"/>
